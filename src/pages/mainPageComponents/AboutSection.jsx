...
const AboutSection = () => {
  return (
    <section
      id="about"
      className="relative py-20 bg-aml-light"
    >
      <div 
      ...
      <div className="relative z-10 container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-5xl font-bold text-aml-dark mb-4">Sobre Nós</h2>
          <div className="w-24 h-1 bg-gradient-to-r from-aml-primary to-aml-action mx-auto"></div>
        </div>
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            <p className="text-xl text-aml-dark/80 leading-relaxed">
            ...
            <div className="grid grid-cols-3 gap-4 pt-6">
              <div className="text-center p-4 bg-white rounded-xl shadow-lg">
                <div className="text-3xl font-bold text-aml-secondary">4</div>
                <div className="text-sm text-aml-dark">Livros</div>
              </div>
              <div className="text-center p-4 bg-white rounded-xl shadow-lg">
                <div className="text-3xl font-bold text-aml-accent">4</div>
                <div className="text-sm text-aml-dark">Cidades</div>
              </div>
              <div className="text-center p-4 bg-white rounded-xl shadow-lg">
                <div className="text-3xl font-bold text-aml-action">5</div>
                <div className="text-sm text-aml-dark">Jogos</div>
              </div>
            </div>
          </div>
