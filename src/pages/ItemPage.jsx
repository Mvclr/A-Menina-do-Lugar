    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-100 flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-6 py-12">
        {isGameVisible && GameComponent ? (
          <div>
            <button onClick={hideGame} className="mb-6 flex items-center gap-2 text-blue-600 hover:text-blue-800 transition-colors font-medium">
              <ArrowLeft size={20} />
              Voltar
            </button>
          ...
          <div>
            <button onClick={hidePdf} className="mb-6 flex items-center gap-2 text-blue-600 hover:text-blue-800 transition-colors font-medium">
              <ArrowLeft size={20} />
              Voltar
            </button>
          ...
          <div>
            <button onClick={hideQuiz} className="mb-6 flex items-center gap-2 text-blue-600 hover:text-blue-800 transition-colors font-medium">
              <ArrowLeft size={20} />
              Voltar
            </button>
          ...
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-extrabold text-gray-800 mb-4 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
              {item.name}
            </h1>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              <div onClick={showPdf} className="text-left cursor-pointer">
                <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl overflow-hidden transform hover:-translate-y-2 transition-all duration-300 group h-full">
              ...
              {gameData && (
                <div onClick={showGame} className="bg-white rounded-2xl shadow-lg hover:shadow-2xl overflow-hidden transform hover:-translate-y-2 transition-all duration-300 cursor-pointer group h-full text-left">
                  ...
                  <div className="p-6 flex flex-col">
                    <h2 className="text-2xl font-bold text-gray-800 mb-3">{gameData.title}</h2>
                    <p className="text-gray-600 mb-6 flex-grow">{gameData.description}</p>
                    <span className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 rounded-xl font-bold text-lg flex items-center justify-center gap-3 group-hover:from-blue-500 group-hover:to-purple-500 transition-all duration-300 mt-auto">
                      <Gamepad2 size={20} />
                      Jogar Agora
                    </span>
              ...
              <div onClick={showQuiz} className="bg-white rounded-2xl shadow-lg hover:shadow-2xl overflow-hidden transform hover:-translate-y-2 transition-all duration-300 cursor-pointer group h-full text-left">
                 <div className={`h-64 bg-gray-900 flex items-center justify-center relative overflow-hidden`}>
                  <div className="text-8xl text-white group-hover:scale-110 transition-transform duration-300">
                    <HelpCircle size={80} />
                  </div>
                ...
                <div className="p-6 flex flex-col">
                  <h2 className="text-2xl font-bold text-gray-800 mb-3">Quiz Rápido</h2>
                  <p className="text-gray-600 mb-6 flex-grow">Teste seus conhecimentos sobre a história de {item.name}!</p>
